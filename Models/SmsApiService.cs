...
namespace RafArasi2.Models
{
    internal class SmsApiService
    {
        ...
        public void SmsSender(string TelNo, string SmsText)
        {
            ...
            testXml += "<username>05377141018</username>";// ileti merkezi kullanııc adınız
            testXml += "<password>Erkan.13</password>";// ileti merkezi kullanıcı şifreniz
            testXml += "</authentication>";
            testXml += "<order>";
